...
ex5Tests = [ testF2 "filterCodes test" filterCodes
             [ (Move [Red, Red, Blue, Green] 1 1, [[Red, Yellow, Yellow, Yellow], [Red, Yellow, Red, Yellow], [Blue, Yellow, Blue, Red]],
               [[Red, Yellow, Red, Yellow], [Blue, Yellow, Blue, Red]])
             ]
           ]
...
ex6Tests = [ testF1 "allCodes test" allCodes
            [(0, [[]]), (1, [[Red], [Green], [Blue], [Yellow], [Orange], [Purple]])]
           ]
